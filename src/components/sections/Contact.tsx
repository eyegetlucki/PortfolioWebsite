      ...
      <div className="max-w-2xl mx-auto text-center">
        <AnimatedSection>
          ...
          <p className="text-base mb-12 max-w-lg mx-auto" style={{ color: '#475569' }}>
            Actively looking for full-time AI/ML engineering and backend roles. Also open to contract work on LLM integrations, RAG pipelines, and agentic systems.
          </p>
          ...
          >
            ...
            {/* LinkedIn */}
            <div className="flex items-center gap-3">
              <span style={{ color: '#64748b' }}><LinkedInIcon /></span>
              <a
                href="https://www.linkedin.com/in/laitrell-uy-xayachak-88793824b/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-medium transition-colors duration-150"
                style={{ color: '#8b5cf6' }}
                ...
                onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color = '#8b5cf6' }}
              >
                linkedin.com/in/laitrell-uy-xayachak
              </a>
            </div>
          ...
          <p className="text-xs mt-6" style={{ color: '#334155' }}>
            Based in Fairfax, VA — available immediately, open to remote or hybrid roles.
          </p>
        </AnimatedSection>
      </div>
    </section>
